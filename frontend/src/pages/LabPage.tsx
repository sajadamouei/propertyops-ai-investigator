    ...
    <div className="lab-page">
      <div className="lab-page-inner">
        <header className="lab-page-header">
          <div><span className="lab-title-icon"><FlaskConical size={18} /></span><div><span className="lab-eyebrow">Engineering workspace</span><h1>Investigation Lab</h1><p>Step through the pipeline using deterministic backend outputs and the orchestrated AI workflow.</p></div></div>
        ...
        />
        <footer className="lab-footer"><span className={`scenario-dot scenario-${runState.config.scenario}`} /> Pipeline stages use the FastAPI backend · AI investigation and approval are orchestrated by LangGraph</footer>
      </div>
    </div>
  )
}
